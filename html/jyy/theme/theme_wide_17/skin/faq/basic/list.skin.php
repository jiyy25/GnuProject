...
if ($himg_src) {
    echo '<div id="faq_himg" class="faq_img d-flex justify-content-center align-items-center" style="background:url('.$himg_src.') no-repeat center">';
    echo '<h2>FAQ</h2>';
...
if ($admin_href)
    echo '<div class="container mt-5 faq_admin"><a href="'.$admin_href.'" class="btn_admin btn">FAQ 수정</a></div>';
