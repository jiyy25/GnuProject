...
<?php
add_javascript('<script src="'.G5_THEME_URL.'/assets/swiper/swiper-bundle.min.js"></script>', 0);
add_javascript('<script src="'.G5_THEME_URL.'/assets/aos/aos.js"></script>', 0);

add_javascript('<script src="'.G5_THEME_URL.'/assets/jquery/jquery.js"></script>', 0);
...
<link rel="stylesheet" href="<?php echo G5_THEME_URL?>/assets/aos/aos.css" >
